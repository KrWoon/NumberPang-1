...
public class RankHellActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView hellBack = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rank_hell);
        ...
        hellBack = (TextView) findViewById(R.id.Rank_Hell_Back);
        hellBack.setOnClickListener(this);
        showRank("Hell");
    }

    public void onClick(View v) {
        switch(v.getId()) {
            case R.id.Rank_Hell_Back:
